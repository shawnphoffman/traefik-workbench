/**
 * Traefik Proxy brand mark, inlined as a React component so it can be
 * recolored with Tailwind text-color classes (the path uses
 * `fill="currentColor"`). Source SVG: src/app/traefikproxy.svg.
 */
